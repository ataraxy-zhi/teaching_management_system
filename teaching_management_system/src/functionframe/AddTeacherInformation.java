...
import userinformation.Teacher;
...
public class AddTeacherInformation extends JFrame {
	 ...
	 * Create the frame.
	 */
	public userinformation.Teacher[] getNewteachers(){
		userinformation.Teacher teachers[] = new userinformation.Teacher[100]; 
		int j = 0;
		for(int i = 0;i<100;i++){
			if(table.getValueAt(i, 0) == null ||
				...
				continue;
			teachers[j] = new userinformation.Teacher(null
	...
	public AddTeacherInformation() {
		...
		scrollPane.setBounds(26, 13, 380, 198);
		...
		btnConfirm.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				try {
					dataprocessing.DataHandling.addTeacherInfomation(getNewteachers());
