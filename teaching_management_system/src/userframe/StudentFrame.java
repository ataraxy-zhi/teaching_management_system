...
import functionframe.CheckGrade;
import functionframe.CourseSelecting;
...
public class StudentFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				try {
					StudentFrame frame = new StudentFrame("030001","tom",new User("030001",
							"tom", "123456", "student"));
	 ...
	 * Create the frame.
	 */
	public StudentFrame(String id,String name,User user) {
		this.user=user;
		...
		btnLookScores.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				try {
					btnLookScoresClicked(e);
	...
	public void btnLookScoresClicked(ActionEvent event) throws ClassNotFoundException, SQLException {
		CheckGrade frame = new CheckGrade(user);
		frame.setVisible(true);
	}
