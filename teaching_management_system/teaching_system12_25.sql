...
INSERT INTO `course` VALUES ('0001','c++',3.5,'0001'),('0002','java',2.5,'0001'),('0003','python',4.0,'0001');
...
INSERT INTO `user` VALUES ('010001','bob','123','administrator'),('020001','mike','123','teacher'),('020002','mary','654321','teacher'),('020003','amy','123','teacher'),('030001','tom','123','student'),('030002','lucy','456789','student');
...
CREATE TABLE `teacher` (
  ...
  CONSTRAINT `教师id` FOREIGN KEY (`teac_id`) REFERENCES `user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `teacher` VALUES ('020001','mike','0001'),('020002','mary','0001'),('020003','amy','0001');
...
CREATE TABLE `begin_course` (
  ...
  CONSTRAINT `begin_course_ibfk_4` FOREIGN KEY (`bc_classroom`) REFERENCES `classroom` (`classroom_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `begin_course` VALUES ('000002','0001',NULL,'020001','0001',50,1,'第二周','第五周',' |周六： 第二节 第三节'),('000007','0003','0003','020003','0001',50,NULL,'第二周','第七周',' |周四： 第一节 第二节 第三节 |周五： 第一节 第二节 第三节'),('000008','0001','0001','020001','0001',50,1,'第一周','第四周',' |周三:　 第一节 |周四： 第一节'),('000010','0002','null','020001','0001',50,0,'第一周','第四周',' |周三:　 第一节 第二节 |周四： 第三节 第四节'),('000013','0003','000013','020001','0001',50,0,'第一周','第五周',' |周三:　 第一节 第二节'),('000014','0001','000014','020002','0001',50,0,'第一周','第六周',' |周二:  第四节 |周三:　 第三节 |周四： 第一节');
...
INSERT INTO `student` VALUES ('030001','tom','0001','123456789'),('030002','lucy','0001','987654321');
...
CREATE TABLE `select_course` (
  ...
  KEY `sc_class` (`sc_class`),
  CONSTRAINT `select_course_ibfk_2` FOREIGN KEY (`sc_student`) REFERENCES `student` (`stu_id`),
  CONSTRAINT `select_course_ibfk_3` FOREIGN KEY (`sc_class`) REFERENCES `begin_course` (`bc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `select_course` VALUES ('0001','0001','000002','030001','2019-2020-1',-1.0),('0002','0002','000010','030001','2019-2020-1',-1.0),('0003','0002','000010','030001','2019-2020-1',-1.0),('0004','0003','000007','030001','2019-2020-1',80.0);
...
CREATE TABLE `administrator` (
  ...
  CONSTRAINT `管理员id参考用户id` FOREIGN KEY (`adm_id`) REFERENCES `user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
